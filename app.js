...
const EVENTS = [
    {
        id: 1,
        title: 'Senior & Junior Gym Buddies',
        emoji: '🤝',
        category: 'intergenerazionale',
        badge: 'Intergenerazionale',
        badgeCls: 'bg-purple-100 text-purple-700',
        headerGradient: 'linear-gradient(135deg,#ede9fe,#fce7f3)',
        color: '#7C3AED',
        description: 'Allenati in coppia con un partner di un\'altra generazione e ottieni uno sconto speciale. Nonni e nipoti, o accoppiamenti casuali guidati dai nostri trainer certificati.',
        highlights: ['Sconto 30% sull\'abbonamento', 'Trainer dedicato alla coppia', 'Kit di benvenuto per entrambi'],
        promo: 'Sconto 30% per le coppie intergenerazionali',
        cta: 'Prenota Ora'
    },
    {
        id: 2,
        title: 'Open Day Move Together',
        emoji: '🎉',
        category: 'tutti',
        badge: 'Gratuito · Per tutti',
        badgeCls: 'bg-green-100 text-green-700',
        headerGradient: 'linear-gradient(135deg,#d1fae5,#ccfbf1)',
        color: '#059669',
        description: 'Un giorno di prova completamente gratuito per entrambe le fasce d\'età. Scopri la struttura, incontra i trainer e vivi la prima esperienza Move Together senza alcun impegno.',
        highlights: ['Ingresso 100% gratuito', 'Tour guidato della struttura', 'Mini sessione con personal trainer'],
        promo: 'Ingresso GRATUITO – nessun obbligo',
        cta: 'Registrati Gratis'
    },
    {
        id: 3,
        title: 'Workshop Longevità & Energia',
        emoji: '🧘',
        category: 'senior',
        badge: 'Per Over 60',
        badgeCls: 'bg-blue-100 text-blue-700',
        headerGradient: 'linear-gradient(135deg,#dbeafe,#e0e7ff)',
        color: '#2563EB',
        description: 'Sessioni di ginnastica dolce e posturale dove i ragazzi assistono e si allenano fianco a fianco con i senior. Un percorso guidato per muoversi con sicurezza, gioia e consapevolezza.',
        highlights: ['Ginnastica dolce e stretching', 'Posturale e respirazione', 'Nutrizione per la longevità'],
        promo: 'Primo workshop a €5 invece di €25',
        cta: 'Prenota Ora'
    },
    {
        id: 4,
        title: 'Summer Buddy Challenge',
        emoji: '☀️',
        category: 'giovani',
        badge: 'Per Giovani',
        badgeCls: 'bg-orange-100 text-orange-700',
        headerGradient: 'linear-gradient(135deg,#ffedd5,#fef3c7)',
        color: '#EA580C',
        description: 'Sfida estiva esclusiva per i giovani dai 16 ai 20 anni. Completa 10 sessioni in coppia con un partner Senior e vinci un abbonamento gratuito di 3 mesi.',
        highlights: ['3 mesi di abbonamento in palio', 'App di tracking inclusa', 'Badge esclusivi sbloccabili'],
        promo: '3 mesi GRATIS completando la sfida',
        cta: 'Partecipa alla Sfida'
    },
    {
        id: 5,
        title: 'Pilates Generations',
        emoji: '🌿',
        category: 'intergenerazionale',
        badge: 'Intergenerazionale',
        badgeCls: 'bg-purple-100 text-purple-700',
        ...
        color: '#047857',
        description: 'Lezioni di Pilates appositamente progettate per essere praticate insieme da giovani e senior. Livelli differenziati, stesso spazio, stessa energia positiva.',
        highlights: ['Classi miste garantite', 'Attrezzatura professionale inclusa', 'Certificato di partecipazione'],
        promo: 'Prova gratuita + 20% sconto mensile',
        cta: 'Prenota una Classe'
    },
    {
        id: 6,
        title: 'Move Together App Beta',
        emoji: '📱',
        category: 'giovani',
        badge: 'Per Giovani',
        badgeCls: 'bg-orange-100 text-orange-700',
        headerGradient: 'linear-gradient(135deg,#e0e7ff,#ede9fe)',
        color: '#4F46E5',
        description: 'Accesso anticipato alla nostra app di tracking e gamification. Registra passi, sfide completate e gestisci i tuoi badge e coupon digitali direttamente dallo smartphone.',
        highlights: ['Accesso beta in anteprima assoluta', 'Notifiche sfide settimanali', 'QR coupon digitali integrati'],
        promo: 'Accesso gratuito per i primi 500 iscritti',
        cta: 'Scarica il Coupon'
    }
];
...
const GYMS = [
    ...
    { id: 'palermo',  name: 'SportSicilia Palermo Libertà',       address: 'Via della Libertà 55, 90143 Palermo',         lat: 38.1157, lng: 13.3615, type: 'partner', phone: '091 789 012',  rating: 4.4, promos: ['Open Day Move Together', 'Senior & Junior Gym Buddies'] },
...
const CHALLENGES = [
    {
        id: 1, title: '10.000 Passi Condivisi',
        description: 'Cammina 10.000 passi insieme a un Over 60. Documenta il percorso con una foto da condividere nella community.',
        icon: 'fa-walking', iconColor: '#FF6B35',
        xp: 150, badge: '🚶', badgeName: 'Camminatore', difficulty: 'Facile', diffColor: '#10B981',
        reward: '5% sconto extra in palestra', progress: 72, completed: false
    },
    {
        id: 2, title: 'Insegna un\'App Tech a un Senior',
        description: 'Mostra a un Over 60 come usare un fitness tracker o l\'app Move Together. Aiutalo a registrare il suo primo allenamento digitale.',
        icon: 'fa-mobile-alt', iconColor: '#3B82F6',
        xp: 200, badge: '📱', badgeName: 'Tech Mentor', difficulty: 'Media', diffColor: '#F59E0B',
        reward: 'Accesso beta app + 1 mese gratis', progress: 0, completed: false
    },
    {
        id: 3, title: 'Sessione Stretching Condivisa',
        description: 'Partecipa a una sessione di stretching o yoga di almeno 30 minuti insieme a un partecipante Over 60 del tuo centro.',
        icon: 'fa-spa', iconColor: '#1F6B52',
        xp: 120, badge: '🧘', badgeName: 'Zen Master', difficulty: 'Facile', diffColor: '#10B981',
        reward: 'Ingresso gratuito al prossimo Open Day', progress: 100, completed: true
    },
    {
        id: 4, title: 'Sfida dei 30 Giorni',
        description: 'Mantieni l\'allenamento per 30 giorni consecutivi. Almeno 2 sessioni a settimana devono essere condivise con un partner.',
        icon: 'fa-fire', iconColor: '#EF4444',
        xp: 500, badge: '🔥', badgeName: 'Fuoco Sacro', difficulty: 'Difficile', diffColor: '#EF4444',
        reward: 'Un mese di abbonamento GRATIS', progress: 40, completed: false
    },
    {
        id: 5, title: 'Ricetta Sana Intergenerazionale',
        description: 'Prepara un pasto salutare insieme a un Senior o un Giovane e condividi la ricetta nella community Move Together.',
        icon: 'fa-utensils', iconColor: '#8B5CF6',
        xp: 100, badge: '🍎', badgeName: 'Chef Salute', difficulty: 'Facile', diffColor: '#10B981',
        reward: 'Badge esclusivo + 10% sconto caffetteria', progress: 0, completed: false
    },
    {
        id: 6, title: 'Porta un Amico al Move Together',
        description: 'Invita un amico (di qualsiasi età!) al prossimo Open Day. Se si iscrive, entrambi ricevete un mese di abbonamento omaggio.',
        icon: 'fa-user-plus', iconColor: '#EC4899',
        xp: 250, badge: '🤝', badgeName: 'Ambasciatore', difficulty: 'Media', diffColor: '#F59E0B',
        reward: '1 mese GRATIS per te e per il tuo amico', progress: 0, completed: false
    }
];
...
function buildEventCard(ev) {
    ...
    card.innerHTML = `
        <div class="event-card-header" style="background:${ev.headerGradient}">
            <span>${ev.emoji}</span>
        </div>
        <div class="p-6">
            ...
            <ul class="space-y-1.5 mb-5">
                ...
                <li class="flex items-center gap-2 text-sm text-gray-600">
                    <i class="fas fa-check-circle text-xs" style="color:${ev.color}"></i>${h}
                </li>`).join('')}
            </ul>
...
function initMap() {
    ...
    GYMS.forEach(gym => {
        const icon = gym.type === 'main' ? mkMain : mkPartner;
        L.marker([gym.lat, gym.lng], { icon })
            .addTo(map)
            .bindPopup(buildPopupHTML(gym), { maxWidth: 280, minWidth: 280 });
    });
}
...
function buildPopupHTML(gym) {
    const stars = '★'.repeat(Math.floor(gym.rating)) + (gym.rating % 1 >= 0.5 ? '½' : '');
    return `
    <div style="font-family:'Inter',sans-serif;overflow:hidden;border-radius:18px;">
        <div style="background:linear-gradient(135deg,#FF6B35,#FF8A5B);padding:14px 18px;color:white;">
            <div style="font-size:10px;font-weight:800;letter-spacing:.1em;text-transform:uppercase;opacity:.85;margin-bottom:3px;">
                ${gym.type === 'main' ? '⭐ SEDE PRINCIPALE ANIF' : '📍 CENTRO PARTNER'}
            </div>
        ...
        <div style="padding:14px 18px;background:white;">
            ...
            ${gym.promos.map(p => `
            <div style="font-size:12px;color:#374151;font-weight:500;margin-bottom:3px;display:flex;gap:5px;align-items:flex-start;">
                <span style="color:#FF6B35;flex-shrink:0;margin-top:1px;">✓</span>${p}
            </div>`).join('')}
            ...
            <button onclick="selectGym('${gym.id}')" style="
                ...
                onmouseover="this.style.background='#E55A25'"
...
function buildChallengeCard(ch) {
    ...
    const progressBar = ch.progress > 0 ? `
        <div class="mb-4">
            <div style="display:flex;justify-content:space-between;font-size:11px;margin-bottom:4px;">
                ...
                <span style="color:white;font-weight:700;">${ch.progress}%</span>
            </div>
    ...
    const actionBtn = ch.completed
        ...
        : `<button onclick="openModal()" style="font-size:11px;background:#FF6B35;color:white;font-weight:700;padding:6px 14px;border-radius:9999px;border:none;cursor:pointer;transition:background .2s;" onmouseover="this.style.background='#E55A25'" onmouseout="this.style.background='#FF6B35'">Inizia →</button>`;
...
function renderBadges() {
    ...
    BADGES.forEach(b => {
        ...
        el.innerHTML = `
            <span class="badge-emoji">${b.unlocked ? b.icon : '🔒'}</span>
            <span class="badge-label ${b.unlocked ? 'text-white' : 'text-white/30'}">${b.unlocked ? b.name : '???'}</span>`;
        grid.appendChild(el);
    });
}
...
function renderForm(preGroup, preOffer) {
    ...
    const gymOptions = GYMS.map(g =>
        `<option value="${g.id}" ${selectedGym && selectedGym.id === g.id ? 'selected' : ''}>${g.name}</option>`
    ).join('');
    ...
    <div style="position:sticky;top:0;z-index:10;background:white;border-bottom:1px solid #f3f4f6;border-radius:24px 24px 0 0;padding:22px 24px;display:flex;align-items:flex-start;justify-content:space-between;gap:12px;">
        <div>
            ...
            <p style="font-size:13px;color:#6B7280;margin:0;">Compila il form per ricevere il tuo coupon digitale Move Together</p>
        </div>
    ...
    <form id="booking-form" onsubmit="handleSubmit(event)" style="padding:24px;display:flex;flex-direction:column;gap:18px;">
        <div>
            ...
            <input type="text" id="f-name" class="form-input" placeholder="Es. Marco Rossi" required autocomplete="name">
        </div>
        <div>
        ...
        <div>
            ...
            <input type="email" id="f-email" class="form-input" placeholder="la.tua@email.com" required autocomplete="email">
        </div>
        <div>
        ...
        <div style="display:flex;align-items:flex-start;gap:10px;padding-top:4px;">
            ...
            <label for="f-privacy" style="font-size:13px;color:#6B7280;line-height:1.5;cursor:pointer;">
                Acconsento al trattamento dei dati personali ai sensi del GDPR per ricevere la promozione Move Together.
                <a href="https://anifeurowellness.it/" target="_blank" style="color:#FF6B35;font-weight:600;">Privacy Policy ANIF</a>
            </label>
        </div>
        <button type="submit" style="width:100%;padding:16px;background:#FF6B35;color:white;border:none;border-radius:14px;font-family:'Poppins',sans-serif;font-weight:800;font-size:1rem;cursor:pointer;transition:all .2s;display:flex;align-items:center;justify-content:center;gap:10px;box-shadow:0 6px 20px rgba(255,107,53,.35);" onmouseover="this.style.background='#E55A25';this.style.transform='scale(1.01)'" onmouseout="this.style.background='#FF6B35';this.style.transform='scale(1)'">
            <i class="fas fa-ticket-alt"></i>
            Genera il mio Coupon Digitale
            <i class="fas fa-arrow-right" style="font-size:.8rem;opacity:.7;"></i>
        </button>
    </form>`;
    ...
    document.getElementById('f-age').addEventListener('input', function () {
        ...
        if (v >= 16 && v <= 20) {
            hint.textContent = '✅ Fascia Giovani (16-20) – accedi alle offerte dedicate!';
            hint.style.color = '#FF6B35'; hint.style.fontWeight = '600';
        } else if (v >= 60) {
            hint.textContent = '✅ Fascia Over 60 – accedi ai percorsi per la longevità attiva!';
            hint.style.color = '#1F6B52'; hint.style.fontWeight = '600';
        } else if (v > 0) {
            hint.textContent = '💡 Anche le altre fasce d\'età possono partecipare all\'Open Day!';
            hint.style.color = '#9CA3AF'; hint.style.fontWeight = '400';
...
function handleSubmit(e) {
    ...
    const bookings = JSON.parse(localStorage.getItem('mt_bookings') || '[]');
    bookings.push({ name, age, email, gymId, offer, code, ts: Date.now() });
    localStorage.setItem('mt_bookings', JSON.stringify(bookings));

    renderCoupon({ name, age, email, gym, offer, code });
}
...
/* ══════════════════════════════════════════════
   COUPON RENDERING
   ══════════════════════════════════════════════ */
function renderCoupon({ name, age, email, gym, offer, code }) {
    const box = document.getElementById('modal-box');
    const isYoung = age >= 16 && age <= 20;
    const isSenior = age >= 60;
    const group  = isSenior ? 'Over 60' : isYoung ? 'Giovane (16-20)' : 'Partecipante';
    const gColor = isSenior ? '#1F6B52' : '#FF6B35';
    ...
    <div style="position:sticky;top:0;z-index:10;background:white;border-bottom:1px solid #f3f4f6;border-radius:24px 24px 0 0;padding:20px 24px;display:flex;align-items:flex-start;justify-content:space-between;gap:12px;">
        <div>
            ...
            <p style="font-size:13px;color:#6B7280;margin:0;">Mostralo alla reception della sede ANIF selezionata</p>
        </div>
        <button onclick="closeModal()" style="width:38px;height:38px;border-radius:10px;background:#F3F4F6;border:none;cursor:pointer;flex-shrink:0;display:flex;align-items:center;justify-content:center;font-size:15px;color:#6B7280;margin-top:2px;" onmouseover="this.style.background='#E5E7EB'" onmouseout="this.style.background='#F3F4F6'">✕</button>
    </div>
    <div style="padding:24px;">
            ...
            <div style="padding:20px 22px;background:white;">
                ...
                <div style="display:flex;align-items:center;gap:14px;padding-bottom:16px;border-bottom:2px dashed #E5E7EB;margin-bottom:14px;">
                    ...
                    <div>
                        ...
                        <span style="font-size:11px;font-weight:700;padding:3px 10px;border-radius:9999px;color:white;background:${gColor};">${group}</span>
                ...
                <div style="background:#F9FAFB;border-radius:12px;padding:10px 14px;margin-bottom:14px;border:1px solid #F3F4F6;">
                    ...
                    <p style="font-weight:700;color:#374151;font-size:0.9rem;margin:0;">${gym ? gym.name : 'Da confermare'}</p>
                    ${gym ? `<p style="font-size:12px;color:#9CA3AF;margin:2px 0 0;">${gym.address}</p>` : ''}
                </div>
                <!-- Code + QR -->
                ...
                <div style="border-top:2px dashed #E5E7EB;padding-top:10px;display:flex;justify-content:space-between;font-size:11px;color:#9CA3AF;">
                    ...
                    <span>Non cedibile · Non cumulabile</span>
                </div>
            </div>
        </div>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:10px;">
            <button onclick="printCoupon()" style="display:flex;align-items:center;justify-content:center;gap:8px;padding:12px;background:#F3F4F6;color:#374151;border:none;border-radius:12px;font-weight:700;font-size:13px;cursor:pointer;transition:background .2s;" onmouseover="this.style.background='#E5E7EB'" onmouseout="this.style.background='#F3F4F6'">
                <i class="fas fa-print"></i>Stampa
            </button>
            <button onclick="shareCoupon('${code}')" style="display:flex;align-items:center;justify-content:center;gap:8px;padding:12px;background:#1F6B52;color:white;border:none;border-radius:12px;font-weight:700;font-size:13px;cursor:pointer;transition:background .2s;" onmouseover="this.style.background='#155240'" onmouseout="this.style.background='#1F6B52'">
                <i class="fas fa-share-alt"></i>Condividi
            </button>
        </div>
        <button onclick="closeModal()" style="width:100%;padding:12px;border:2px solid #E5E7EB;background:transparent;color:#6B7280;border-radius:12px;font-weight:600;font-size:13px;cursor:pointer;transition:all .2s;" onmouseover="this.style.background='#F9FAFB'" onmouseout="this.style.background='transparent'">
        ...
        <p style="text-align:center;font-size:11px;color:#9CA3AF;margin-top:12px;">
            ...
            Simulato: in produzione riceveresti questo coupon via email a <strong style="color:#6B7280;">${email}</strong>
        </p>
    </div>`;
    ...
    setTimeout(() => {
        ...
        if (slot && typeof QRCode !== 'undefined') {
            slot.innerHTML = '';
            new QRCode(slot, {
                text: `MOVETOGETHER:${code}:${name.replace(/ /g, '_')}`,
                width: 92, height: 92,
...
function buildBarcode() {
    const pattern = [3,1,2,1,3,2,1,2,1,3,1,2,3,1,2,1,3,2,1,2,1,3,1,2,1,3,2,1,2,1,3,1,2,3,1,2,1,3,2,1,2,1,3,1,2,3,1,2];
    return pattern.map((w, i) => {
        const h = 30 + (i % 3 === 0 ? 12 : i % 2 === 0 ? 6 : 0);
        if (i % 2 === 0) {
            return `<div class="barcode-bar" style="width:${w * 2.2}px;height:${h}px;align-self:flex-end;"></div>`;
        }
        return `<div style="width:${w * 2.2}px;height:${h}px;align-self:flex-end;"></div>`;
    }).join('');
}
...
function printCoupon() {
    ...
    w.document.write(`<!DOCTYPE html><html><head>
        <meta charset="UTF-8">
        <title>Coupon Move Together – ${document.getElementById('print-coupon').querySelector('p[style*="font-size:1.15rem"]')?.textContent || ''}</title>
        ...
        <style>
            body{margin:40px auto;max-width:480px;font-family:'Inter',sans-serif;background:#f8f7f4;}
            .coupon-wrap{border:3px dashed #FF6B35;border-radius:20px;overflow:hidden;}
...
function shareCoupon(code) {
    ...
    if (navigator.share) {
        ...
        navigator.clipboard.writeText(text).then(() => {
            alert('Testo copiato negli appunti! Incollalo dove vuoi per condividerlo. 📋');
        }).catch(() => {
            prompt('Copia il testo qui sotto:', text);
        });
    }
}
